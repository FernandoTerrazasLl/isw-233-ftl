...
class ProjectsSection extends BaseSection {
    async getTemplateData() {
        return {
            ...
            moreProjectsIcon: "/components/projects/image/iconoGithubMin.png",
            projects: [
                {
                    image: "/components/projects/image/imagenMecaProyecto.png",
                    ...
                    repositoryIcon: "/components/projects/image/iconoGithubMinNegro.png",
                },
                {
                    image: "/components/projects/image/imagenArquitectura.png",
                ...
                {
                    image: "/components/projects/image/imagenPasa.png",
